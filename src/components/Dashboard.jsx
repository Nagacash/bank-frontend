  ...
  return (
    <div>
      <aside className="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3  " id="sidenav-main">
        <div className="sidenav-header">
          ...
          <a className="navbar-brand m-0" href=" https://nagaswap.com " target="_blank">
            {/* <img src={NagaLogo} className='navbar-brand-img smalli ' alt='NagA' /> */}
            {/* <span className="ms-1 font-weight-bold cent text fonti" id="fonti"><div className="fonti">Naga Banking</div></span> */}
          </a>
        </div> {/*
    ...
    <div className="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul className="navbar-nav">
        ...
        <li className="nav-item">
          <a className="nav-link  " href="../pages/tables.html">
            ...
            <span className="nav-link-text ms-1">Balance</span>
          </a>
        </li>
        <li className="nav-item">
                  ...
                  <g transform="translate(-1870.000000, -591.000000)" fill="#FFFFFF" fillRule="nonzero">
                    <g transform="translate(1716.000000, 291.000000)">
                      <g transform="translate(154.000000, 300.000000)">
                        <path className="color-background opacity-6" d="M40,40 L36.3636364,40 L36.3636364,3.63636364 L5.45454545,3.63636364 L5.45454545,0 L38.1818182,0 C39.1854545,0 40,0.814545455 40,1.81818182 L40,40 Z">
                        </path>
      ...
      <div className="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
        <div className="full-background" style={{backgroundImage: 'url("../assets/img/curved-images/white-curved.jpg")'}}>
        </div>
      ...
      <main className="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
            ...
            <div className="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
              ...
              <ul className="navbar-nav  justify-content-end">
                <li className="nav-item d-flex align-items-center">
                  <a className="btn btn-outline-dark btn-sm mb-0 me-3" target="_blank" href="https://www.nagaswap.com/">NagaSwap</a>
                </li>
                <li className="nav-item d-flex align-items-center">
                  <a href="./components/SignIn" className="nav-link text-body font-weight-bold px-0">
        ...
        {/* End Navbar */}
        <div className="container-fluid py-4 card shadow-lg">
          <div className="row">
                  ...
                  <div className="row">
                    <div className="col-8">
                      <div className="numbers">
                        <button className="m-2 bg-dark"><p className="text-sm mb-0 text-capitalize font-weight-bold text-light m-1">Balance</p></button>
              ...
              <div className="card">
                <div className="card-body p-3">
                  <div className="row">
                    <div className="col-8">
                      <div className="numbers">
                        <button className="m-2 bg-dark"> <p className="text-sm mb-0 text-capitalize font-weight-bold text-light m-1">Savings</p>
                        </button>
              ...
              <div className="card">
                <div className="card-body p-3">
                  <div className="row">
                    <div className="col-8">
                      <div className="numbers">
                        <button className="m-2 bg-dark"> <p className="text-sm mb-0 text-capitalize font-weight-bold text-light m-1">Transaction</p>
                        </button>
                        <h5 className="font-weight-bolder mb-0">
                          +3,462
              ...
              <div className="card">
                <div className="card-body p-3">
                  <div className="row">
                    <div className="col-8">
                      <div className="numbers">
                        <button className="m-2 bg-warning bg-dark">
                          <p className="text-sm mb-0 text-capitalize font-weight-bold text-light m-1">Spending</p>
                        </button>
                        <h5 className="font-weight-bolder mb-0">
                          $103,430
          ...
          <div className="row mt-4">
                  ...
                  <div className="row">
                    <div className="col-lg-6">
                      <div className="d-flex flex-column h-100">
                        <p className="mb-1 pt-2 text-bold">monthly</p>
                        <h5 className="font-weight-bolder">Transaction</h5>
                        <p className="mb-5" />
                      </div>
                    </div>
                    <div className="col-lg-5 ms-auto text-center mt-5 mt-lg-0">
                      <div className=" border-radius-lg h-100">
                        ...
                        <div className="position-relative d-flex align-items-center justify-content-center h-100">
                          <img className="w-100 position-relative z-index-2 pt-4" src={Rocket} alt="rocket" />
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div className="col-lg-5">
              <div className="card h-100 p-3">
                <div className="overflow-hidden position-relative border-radius-lg bg-cover h-100" style={{ backgroundImage: 'url("../assets/img/curved-images/d.jpg")' }}>
                  <span className="mask bg-gradient-dark" />
                  <div className="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
                    <h5 className="text-white font-weight-bolder mb-4 pt-2">BUY Crypto</h5>
                    <p className="text-white">The Naga Swap Protocol is a protocol for trading ERC20 tokens on Ethereum,
                      Binance, Polygon..</p>
                    <a className="text-white text-sm font-weight-bold mb-0 icon-move-right mt-auto" href="javascript:;">
                      Read More
                      <i className="fas fa-arrow-right text-sm ms-1" href="https://www.nagaswap.com/" />
                    </a>
                  </div>
                </div>
              </div>
            ...
            <div className="col-lg-5 mb-lg-0 mb-4">
              <div className="card z-index-2">
                <div className="card-body p-3">
                  ...
                  <h6 className="ms-2 mt-4 mb-0"> Activity </h6>
        ...
        <div className="card shadow-lg ">
          <div className="card-header pb-0 pt-3 ">
            <div className="float-start text-center">
              <h3 className="mt-3 mb-0 text-center">One app, all
                things money</h3>
              <p>From easy money management, to travel perks and investments</p>
            </div>
          ...
          <div className="card-body pt-sm-3 pt-0">
            {/* Sidebar Backgrounds */}
            <div>
              <h6 className="mb-0 bg-warning text-center">Send, spend and save smarter, Pay & transfer</h6>
            </div>
            ...
            <div className="mt-3">
              ...
              <p className="text-sm ">Check your balance, deposit checks,Footnote2 view statements, pay bills, transfer money between your accounts and set up alertsFootnote3 through email, text or push notifications. Browse cash-back deals with BankAmeriDeals®Footnote4 no matter where you are. It's all right at your fingertips, on your timeline..</p>
            </div>
            <div className="d-flex">
              {/* <button className="btn bg-gradient-primary w-100 px-3 mb-2 active" data-class="bg-transparent" onclick="sidebarType(this)"> No minimums,</button>
          <button className="btn bg-gradient-primary w-100 px-3 mb-2 ms-2" data-class="bg-white" onclick="sidebarType(this)">No monthly fees</button> */}
            </div>
            ...
            <a className="btn btn-outline-dark w-100" href="https://www.creative-tim.com/learning-lab/bootstrap/license/soft-ui-dashboard">Sign Out</a>
            <div className="w-100 text-center">
              ...
              <a href="https://www.facebook.com/sharer/sharer.php?u=https://www.naga-mint.com" className="btn btn-dark mb-0 me-2" target="_blank">
          ...
          <div className="row align-items-center justify-content-lg-between">
            <div className="col-lg-6 mb-lg-0 mb-4">
              <div className="copyright text-center text-sm text-muted text-lg-start">
                © Naga Apparel
                ,
                designed <i className="fa fa-heart" /> by
                <a href="https://www.creative-tim.com" className="font-weight-bold" target="_blank"> Maurice Holda</a>
              </div>
            </div>
            <div className="col-lg-6">
              <ul className="nav nav-footer justify-content-center justify-content-lg-end">
                <li className="nav-item">
                  <a href="https://www.nagaswap.com" className="nav-link text-muted" target="_blank">Naga Swap</a>
                </li>
                <li className="nav-item">
                  <a href="https://www.naga-clothing.com" className="nav-link text-muted" target="_blank">About Us</a>
                </li>
                <li className="nav-item">
                  <a href="https://www.naga-mint.com" className="nav-link text-muted" target="_blank">NFT Mint</a>
                </li>
                <li className="nav-item">
                  <a href="https://www.streamii.de" className="nav-link pe-0 text-muted" target="_blank">Streamii</a>
                </li>
              </ul>
            </div>
          </div>
